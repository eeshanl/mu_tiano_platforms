...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("HAF_TFA_BUILD", "TRUE", "Default to false when not running in CI")
    ...
    def HafTfaBuild(self):
        ...
        output_dir = "Platforms/QemuSbsaPkg/HafTfaBuild/firmware_binaries"
        os.makedirs(output_dir, exist_ok=True)

        # Copy Hafnium binary
        hafnium_src = os.path.join(self.env.GetValue('ARM_HAF_PATH'), 'out/mu/secure_qemu_aarch64_clang', 'hafnium.bin')
