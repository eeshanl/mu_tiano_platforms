  ...
  )
{
  ...
  ArmMonitorCall (&SmcArgs);
  DEBUG ((DEBUG_INFO, "distributor ArmMonitorCall return: 0x%llx ", SmcArgs.Arg0));
  if (SmcArgs.Arg0 != SMC_SIP_CALL_SUCCESS) {
  ...
  ArmMonitorCall (&SmcArgs);
  DEBUG ((DEBUG_INFO, "gic ArmMonitorCall return: 0x%llx ", SmcArgs.Arg0));
  if (SmcArgs.Arg0 != SMC_SIP_CALL_SUCCESS) {
  ...
  )
{
  ...
  ArmMonitorCall (&SmcArgs);
  DEBUG ((DEBUG_INFO, "platform ArmMonitorCall return: 0x%llx ", SmcArgs.Arg0));
