/** @file smmuv3registers.h
    ...
    This file is the smmuv3registers header file for SMMU driver for the Qemu SBSA platform.
...
typedef enum _SMMUV3_REVISION {
    ...
    SMMUV3_2,
    SMMUV3_3,
} SMMUV3_REVISION, PSMMUV3_REVISION;
...
typedef union _SMMUV3_IDR1 {
    ...
    UINT32 AsUINT32;
} SMMUV3_IDR1, *PSMMUV3_IDR1;

//
// The VATOS region base address is supplied by the IDR2 register and it
// is expressed as an offset of 0x20000 from SMMU's base address, in units
// of a 64KB page. The VATOS region occupies one 64KB page containing
// the VATOS registers.
//
...
typedef _SMMUV3_CR0ACK SMMUV3_CR0ACK, *PSMMUV3_CR0ACK;
...
typedef union _SMMUV3_GBPA {
    ...
    UINT32 AsUINT32;
} SMMUV3_GBPA, *PSMMUV3_GBPA;

typedef struct _SMMUV3_AGBPA {
    UINT32 Impl;
} SMMUV3_AGBPA, *PSMMUV3_AGBPA;
...
typedef union _SMMUV3_STATUSR {
    ...
    UINT32 AsUINT32;
} SMMUV3_STATUSR, *PSMMUV3_STATUSR;
...
typedef union _SMMUV3_IRQ_CTRL {
    ...
    UINT32 AsUINT32;
} SMMUV3_IRQ_CTRL, *PSMMUV3_IRQ_CTRL;

typedef SMMUV3_IRQ_CTRL _SMMUV3_IRQ_CTRLACK;
typedef _SMMUV3_IRQ_CTRLACK SMMUV3_IRQ_CTRLACK, *PSMMUV3_IRQ_CTRLACK;
...
typedef union _SMMUV3_GERROR {
    ...
    UINT32 AsUINT32;
} SMMUV3_GERROR, *PSMMUV3_GERROR;

typedef SMMUV3_GERROR _SMMUV3_GERRORN;
typedef _SMMUV3_GERRORN SMMUV3_GERRORN, *PSMMUV3_GERRORN;
...
typedef union _SMMUV3_GERROR_IRQ_CFG0 {
    ...
    UINT64 AsUINT64;
} SMMUV3_GERROR_IRQ_CFG0, *PSMMUV3_GERROR_IRQ_CFG0;

typedef struct _SMMUV3_GERROR_IRQ_CFG1 {
    UINT32 Data;
} SMMUV3_GERROR_IRQ_CFG1, *PSMMUV3_GERROR_IRQ_CFG1;
...
typedef union _SMMUV3_GERROR_IRQ_CFG2 {
    ...
    UINT32 AsUINT32;
} SMMUV3_GERROR_IRQ_CFG2, *PSMMUV3_GERROR_IRQ_CFG2;
...
typedef union _SMMUV3_STRTAB_BASE {
    ...
    UINT64 AsUINT64;
} SMMUV3_STRTAB_BASE, *PSMMUV3_STRTAB_BASE;
...
typedef union _SMMUV3_STRTAB_BASE_CFG {
    ...
    UINT32 AsUINT32;
} SMMUV3_STRTAB_BASE_CFG, *PSMMUV3_STRTAB_BASE_CFG;
...
typedef union _SMMUV3_CMDQ_BASE {
    ...
    UINT64 AsUINT64;
} SMMUV3_CMDQ_BASE, *PSMMUV3_CMDQ_BASE;
...
typedef union _SMMUV3_CMDQ_CONS {
    ...
    UINT32 AsUINT32;
} SMMUV3_CMDQ_CONS, *PSMMUV3_CMDQ_CONS;
...
typedef union _SMMUV3_CMDQ_PROD {
    ...
    UINT32 AsUINT32;
} SMMUV3_CMDQ_PROD, *PSMMUV3_CMDQ_PROD;
...
typedef union SMMUV3_EVENTQ_BASE {
    ...
    UINT64 AsUINT64;
} SMMUV3_EVENTQ_BASE, *PSMMUV3_EVENTQ_BASE;
...
typedef union SMMUV3_EVENTQ_CONS {
    ...
    UINT32 AsUINT32;
} SMMUV3_EVENTQ_CONS, *PSMMUV3_EVENTQ_CONS;
...
} SMMUV3_EVENTQ_PROD, *PSMMUV3_EVENTQ_PROD;
...
typedef union _SMMUV3_EVENTQ_IRQ_CFG0 {
    ...
    UINT64 AsUINT64;
} SMMUV3_EVENTQ_IRQ_CFG0, *PSMMUV3_EVENTQ_IRQ_CFG0;

typedef struct _SMMUV3_EVENTQ_IRQ_CFG1 {
    UINT32 Data;
} SMMUV3_EVENTQ_IRQ_CFG1, *PSMMUV3_EVENTQ_IRQ_CFG1;
...
typedef union _SMMUV3_EVENTQ_IRQ_CFG2 {
    ...
    UINT32 AsUINT32;
} SMMUV3_EVENTQ_IRQ_CFG2, *PSMMUV3_EVENTQ_IRQ_CFG2;
...
typedef union _SMMUV3_PRIQ_BASE {
    ...
    UINT64 AsUINT64;
} SMMUV3_PRIQ_BASE, *PSMMUV3_PRIQ_BASE;
...
typedef union _SMMUV3_PRIQ_CONS {
    ...
    UINT32 AsUINT32;
} SMMUV3_PRIQ_CONS, *PSMMUV3_PRIQ_CONS;
...
typedef union _SMMUV3_PRIQ_PROD {
    ...
    UINT32 AsUINT32;
} SMMUV3_PRIQ_PROD, *PSMMUV3_PRIQ_PROD;
...
typedef union _SMMUV3_PRIQ_IRQ_CFG0 {
    ...
    UINT64 AsUINT64;
} SMMUV3_PRIQ_IRQ_CFG0, *PSMMUV3_PRIQ_IRQ_CFG0;

typedef struct _SMMUV3_PRIQ_IRQ_CFG1 {
    UINT32 Data;
} SMMUV3_PRIQ_IRQ_CFG1, *PSMMUV3_PRIQ_IRQ_CFG1;
...
typedef union _SMMUV3_PRIQ_IRQ_CFG2 {
    ...
    UINT32 AsUINT32;
} SMMUV3_PRIQ_IRQ_CFG2, *PSMMUV3_PRIQ_IRQ_CFG2;
...
typedef union _SMMUV3_GATOS_CTRL {
    ...
    UINT32 AsUINT32;
} SMMUV3_GATOS_CTRL, PSMMUV3_GATOS_CTRL;
...
typedef union _SMMUV3_GATOS_SID {
    ...
    UINT64 AsUINT64;
} SMMUV3_GATOS_SID, PSMMUV3_GATOS_SID;
...
typedef union _SMMUV3_GATOS_ADDR {
    ...
    UINT64 AsUINT64;
} SMMUV3_GATOS_ADDR, PSMMUV3_GATOS_ADDR;
...
typedef union _SMMUV3_GATOS_PAR {
    ...
    UINT64 AsUINT64;
} SMMUV3_GATOS_PAR, PSMMUV3_GATOS_PAR;
...
typedef union _SMMUV3_MPAMIDR {
    ...
    UINT32 AsUINT32;
} SMMUV3_MPAMIDR, *PSMMUV3_MPAMIDR;
...
typedef union _SMMUV3_GBPMPAM {
    ...
    UINT32 AsUINT32;
} SMMUV3_GBPMPAM, *PSMMUV3_GBPMPAM;
...
typedef union _SMMUV3_VATOS_SEL {
    ...
    UINT32 AsUINT32;
} SMMUV3_VATOS_SEL, PSMMUV3_VATOS_SEL;
...
} SMMUV3_PIDRS, *PSMMUV3_PIDRS;

typedef struct _SMMUV3_ID_REGS {
    SMMUV3_PIDRS Pidrs;
    SMMUV3_CIDRS Cidrs;
} SMMUV3_ID_REGS, *PSMMUV3_ID_REGS;
...
} SMMUV3_REGISTER_LAYOUT_PAGE0, *PSMMUV3_REGISTER_LAYOUT_PAGE0;
...
} SMMUV3_REGISTER_LAYOUT_PAGE1, *PSMMUV3_REGISTER_LAYOUT_PAGE1;
...
typedef union _SMMUV3_L1_STREAM_TABLE_DESCRIPTOR {
    ...
    UINT64 AsUINT64;
} SMMUV3_L1_STREAM_TABLE_DESCRIPTOR, *PSMMUV3_L1_STREAM_TABLE_DESCRIPTOR;
...
typedef union  _SMMUV3_STREAM_TABLE_ENTRY {
    ...
    UINT64 AsUINT64[8];
} SMMUV3_STREAM_TABLE_ENTRY, *PSMMUV3_STREAM_TABLE_ENTRY;
...
} SMMUV3_STREAM_ENTRY_CONFIG_TYPE, *PSMMUV3_STREAM_ENTRY_CONFIG_TYPE;
...
typedef union _SMMUV3_L1_CONTEXT_DESCRIPTOR {
    ...
    UINT64 AsUINT64;
} SMMUV3_L1_CONTEXT_DESCRIPTOR, *PSMMUV3_L1_CONTEXT_DESCRIPTOR;
...
typedef union  _SMMUV3_CONTEXT_DESCRIPTOR {
    ...
    UINT64 AsUINT64[8];
} SMMUV3_CONTEXT_DESCRIPTOR, *PSMMUV3_CONTEXT_DESCRIPTOR;
...
typedef enum _SMMUV3_COMMAND_OPCODE {
    ...
    CmdStallTerm,
    CmdSync
} SMMUV3_COMMAND_OPCODE, *PSMMUV3_COMMAND_OPCODE;
...
typedef struct _SMMUV3_CMD_CFGI_STE {
    ...
    UINT64 Leaf: 1;
    UINT64 Reserved2: 63;
} SMMUV3_CMD_CFGI_STE, *PSMMUV3_CMD_CFGI_STE;
...
typedef struct _SMMUV3_CMD_CFGI_STE_RANGE {
    ...
    UINT64 Range: 5;
    UINT64 Reserved2: 59;
} SMMUV3_CMD_CFGI_STE_RANGE, *PSMMUV3_CMD_CFGI_STE_RANGE;
...
typedef struct _SMMUV3_CMD_CFGI_CD {
    ...
    UINT64 Leaf: 1;
    UINT64 Reserved2: 63;
} SMMUV3_CMD_CFGI_CD, *PSMMUV3_CMD_CFGI_CD;
...
typedef struct _SMMUV3_CMD_CFGI_CD_ALL {
    ...
    UINT32 StreamId;
    UINT64 Reserved2;
} SMMUV3_CMD_CFGI_CD_ALL, *PSMMUV3_CMD_CFGI_CD_ALL;
...
typedef struct _SMMUV3_CMD_CFGI_VMS_PIDM {
    ...
    UINT32 Reserved2: 16;
    UINT64 Reserved3;
} SMMUV3_CMD_CFGI_VMS_PIDM, *PSMMUV3_CMD_CFGI_VMS_PIDM;
...
typedef struct _SMMUV3_CMD_CFGI_ALL {
    ...
    UINT64 Reserved2: 59;
} SMMUV3_CMD_CFGI_ALL, *PSMMUV3_CMD_CFGI_ALL;
...
typedef struct _SMMUV3_CMD_TLBI_NH_ALL {
    ...
    UINT32 Reserved1: 16;
    UINT64 Reserved2;
} SMMUV3_CMD_TLBI_NH_ALL, *PSMMUV3_CMD_TLBI_NH_ALL;
...
typedef struct _SMMUV3_CMD_TLBI_NH_ASID {
    ...
    UINT32 Asid: 16;
    UINT64 Reserved1;
} SMMUV3_CMD_TLBI_NH_ASID, *PSMMUV3_CMD_TLBI_NH_ASID;
...
typedef struct _SMMUV3_CMD_TLBI_NH_VAA {
    ...
    UINT64 Tg: 2;
    UINT64 Address: 52;
} SMMUV3_CMD_TLBI_NH_VAA, *PSMMUV3_CMD_TLBI_NH_VAA;
...
typedef struct _SMMUV3_CMD_TLBI_NH_VA {
    ...
    UINT64 Tg: 2;
    UINT64 Address: 52;
} SMMUV3_CMD_TLBI_NH_VA, *PSMMUV3_CMD_TLBI_NH_VA;
...
typedef struct _SMMUV3_CMD_TLBI_EL2_ALL {
    ...
    UINT32 Reserved1;
    UINT64 Reserved2;
} SMMUV3_CMD_TLBI_EL2_ALL, *PSMMUV3_CMD_TLBI_EL2_ALL;
...
typedef struct _SMMUV3_CMD_TLBI_EL2_VA {
    ...
    UINT64 Tg: 2;
    UINT64 Address: 52;
} SMMUV3_CMD_TLBI_EL2_VA, *PSMMUV3_CMD_TLBI_EL2_VA;
...
typedef struct _SMMUV3_CMD_TLBI_EL2_VAA {
    ...
    UINT64 Tg: 2;
    UINT64 Address: 52;
} SMMUV3_CMD_TLBI_EL2_VAA, *PSMMUV3_CMD_TLBI_EL2_VAA;
...
typedef struct _SMMUV3_CMD_TLBI_EL2_ASID {
    ...
    UINT32 Asid: 16;
    UINT64 Reserved2;
} SMMUV3_CMD_TLBI_EL2_ASID, *PSMMUV3_CMD_TLBI_EL2_ASID;
...
typedef struct _SMMUV3_CMD_TLBI_S2_IPA {
    ...
    UINT64 Address: 40;
    UINT64 Reserved5: 12;
} SMMUV3_CMD_TLBI_S2_IPA, *PSMMUV3_CMD_TLBI_S2_IPA;
...
typedef struct _SMMUV3_CMD_TLBI_S12_VMALL {
    ...
    UINT32 Reserved1: 16;
    UINT64 Reserved2;
} SMMUV3_CMD_TLBI_S12_VMALL, *PSMMUV3_CMD_TLBI_S12_VMALL;
...
typedef struct _SMMUV3_CMD_TLBI_NSNH_ALL {
    ...
    UINT32 Reserved1;
    UINT64 Reserved2;
} SMMUV3_CMD_TLBI_NSNH_ALL, *PSMMUV3_CMD_TLBI_NSNH_ALL;
...
typedef struct _SMMUV3_CMD_RESUME {
    ...
    UINT64 Stag: 16;
    UINT64 Reserved3: 48;
} SMMUV3_CMD_RESUME, *PSMMUV3_CMD_RESUME;
...
typedef struct _SMMUV3_CMD_STALL_TERM {
    ...
    UINT32 StreamId;
    UINT64 Reserved2;
} SMMUV3_CMD_STALL_TERM, *PSMMUV3_CMD_STALL_TERM;
...
typedef struct _SMMUV3_CMD_SYNC {
    ...
    UINT64 Reserved4: 12;
} SMMUV3_CMD_SYNC, *PSMMUV3_CMD_SYNC;
...
} SMMUV3_CMD_GENERIC, *PSMMUV3_CMD_GENERIC;
...
} SMMUV3_FAULT_TYPE, *PSMMUV3_FAULT_TYPE;
...
typedef struct _SMMUV3_UNSUPPORTED_UPSTREAM_TRANSACTION_FAULT {
    ...
    *PSMMUV3_UNSUPPORTED_UPSTREAM_TRANSACTION_FAULT;
...
typedef struct _SMMUV3_BAD_STREAM_ID_FAULT {
    ...
    UINT64 Reserved2;
    UINT64 Reserved3;
} SMMUV3_BAD_STREAM_ID_FAULT, *PSMMUV3_BAD_STREAM_ID_FAULT;
...
typedef struct _SMMUV3_STREAM_ENTRY_FETCH_ABORT_FAULT {
    ...
    *PSMMUV3_STREAM_ENTRY_FETCH_ABORT_FAULT;
...
typedef struct _SMMUV3_BAD_STREAM_ENTRY_FAULT {
    ...
    UINT64 Reserved2;
    UINT64 Reserved3;
} SMMUV3_BAD_STREAM_ENTRY_FAULT, *PSMMUV3_BAD_STREAM_ENTRY_FAULT;
...
typedef struct _SMMUV3_BAD_ATS_TRANSLATION_REQUEST {
    ...
    UINT64 Reserved4;
} SMMUV3_BAD_ATS_TRANSLATION_REQUEST, *PSMMUV3_BAD_ATS_TRANSLATION_REQUEST;
...
typedef struct _SMMUV3_STREAM_DISABLED_FAULT {
    ...
    UINT64 Reserved2;
    UINT64 Reserved3;
} SMMUV3_STREAM_DISABLED_FAULT, *PSMMUV3_STREAM_DISABLED_FAULT;
...
typedef struct _SMMUV3_TRANSLATION_FORBIDDEN_FAULT {
    ...
    UINT64 InputAddress;
    UINT64 Reserved4;
} SMMUV3_TRANSLATION_FORBIDDEN_FAULT, *PSMMUV3_TRANSLATION_FORBIDDEN_FAULT;
...
typedef struct _SMMUV3_BAD_SUBSTREAM_ID_FAULT {
    ...
    UINT64 Reserved2;
    UINT64 Reserved3;
} SMMUV3_BAD_SUBSTREAM_ID_FAULT, *PSMMUV3_BAD_SUBSTREAM_ID_FAULT;
...
typedef struct _SMMUV3_CONTEXT_DESCRIPTOR_FETCH_ABORT_FAULT {
    ...
    *PSMMUV3_CONTEXT_DESCRIPTOR_FETCH_ABORT_FAULT;
...
typedef struct _SMMUV3_BAD_CONTEXT_DESCRIPTOR_FAULT {
    ...
    UINT64 Reserved2;
    UINT64 Reserved3;
} SMMUV3_BAD_CONTEXT_DESCRIPTOR_FAULT, *PSMMUV3_BAD_CONTEXT_DESCRIPTOR_FAULT;
...
typedef struct _SMMUV3_TRANSLATION_WALK_EXTERNAL_ABORT_FAULT {
    ...
    *PSMMUV3_TRANSLATION_WALK_EXTERNAL_ABORT_FAULT;
...
typedef struct _SMMUV3_TRANSLATION_FAULT {
    ...
    UINT64 Ipa: 40;
    UINT64 Reserved6: 12;
} SMMUV3_TRANSLATION_FAULT, *PSMMUV3_TRANSLATION_FAULT;
...
typedef struct _SMMUV3_ADDRESSS_SIZE_FAULT {
    ...
    UINT64 Ipa: 40;
    UINT64 Reserved6: 12;
} SMMUV3_ADDRESSS_SIZE_FAULT, *PSMMUV3_ADDRESSS_SIZE_FAULT;
...
typedef struct _SMMUV3_ACCESS_FLAG_FAULT {
    ...
    UINT64 Ipa: 40;
    UINT64 Reserved6: 12;
} SMMUV3_ACCESS_FLAG_FAULT, *PSMMUV3_ACCESS_FLAG_FAULT;
...
typedef struct _SMMUV3_PERMISSION_FAULT {
    ...
    UINT64 Ipa: 40;
    UINT64 Reserved6: 12;
} SMMUV3_PERMISSION_FAULT, *PSMMUV3_PERMISSION_FAULT;
...
typedef struct _SMMUV3_TLB_CONFLICT {
    ...
    UINT64 Ipa: 40;
    UINT64 Reserved6: 12;
} SMMUV3_TLB_CONFLICT, *PSMMUV3_TLB_CONFLICT;
...
typedef struct _SMMUV3_CONFIGURATION_CACHE_CONFLICT {
    ...
    UINT64 Reserved2;
    UINT64 Reserved3;
} SMMUV3_CONFIGURATION_CACHE_CONFLICT, *PSMMUV3_CONFIGURATION_CACHE_CONFLICT;
...
typedef struct _SMMUV3_PAGE_REQUEST_FAULT {
    ...
    UINT64 InputAddress: 52;
    UINT64 Reserved7;
} SMMUV3_PAGE_REQUEST_FAULT, *PSMMUV3_PAGE_REQUEST_FAULT;
...
typedef struct _SMMUV3_VMS_FETCH_ABORT_FAULT {
    ...
    UINT64 FetchAddress: 49;
    UINT64 Reserved5: 12;
} SMMUV3_VMS_FETCH_ABORT_FAULT, *PSMMUV3_VMS_FETCH_ABORT_FAULT;
...
typedef struct _SMMUV3_FAULT_GENERIC {
    ...
    UINT64 InputAddress;
    UINT64 Reserved5;
} SMMUV3_FAULT_GENERIC, *PSMMUV3_FAULT_GENERIC;
...
typedef union _SMMUV3_FAULT_RECORD {
    ...
    UINT64 Fault[4];
} SMMUV3_FAULT_RECORD, *PSMMUV3_FAULT_RECORD;
...
//
// N.B. The stream ID is ignored with CMD_CFGI_ALL and thus not set. SSec field
//      will be 0x0 due to zeroing out of the command buffer and thus not set
//      again explicitly.
//
...
//
// N.B. As of now, SMMUv3.2 Range invalidation feature (RIL) is not supported.
//      Thus the Scale, Num (granule multiplier), TG (Translation granule size),
//      and TTL (Translation Table Level) are all set to zero (default).
//
// Specify Leaf as zero as TLB entries cached at all levels of page table walks
// need to be flushed.
//
...
//
// N.B. Scale, Num, TG, Ttl fields are set to zero due to lack of RIL
//      support (refer to SMMUV3_BUILD_CMD_TLBI_NH_VA).
//
// Specify Leaf as zero as TLB entries cached at all levels of page table walks
// need to be flushed.
//
